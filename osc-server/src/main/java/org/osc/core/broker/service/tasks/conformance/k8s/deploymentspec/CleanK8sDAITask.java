 ...
 */
@Component(service = CleanK8sDAITask.class)
public class CleanK8sDAITask extends TransactionalTask {
    private DistributedApplianceInstance dai;

    public CleanK8sDAITask create(DistributedApplianceInstance daiForDeletion) {
        return create(daiForDeletion, null);
    }

    CleanK8sDAITask create(DistributedApplianceInstance dai, KubernetesDeploymentApi k8sDeploymentApi) {
        CleanK8sDAITask task = new CleanK8sDAITask();
    ...
    public String getName() {
        return String.format("Deleting or cleaning the K8s dai %s", this.dai.getName());
    }
