...
public class NotificationListenerFactory {
    ...
    public OsNotificationListener createAndRegisterNotificationListener(VirtualizationConnector vc,
        ...
        switch (objectType) {
        case PORT:
            return new OsPortNotificationListener(vc, objectType, objectIdList, entity, this.sgConformService,
                    this.alertGenerator, this.activeRunner, this.dbMgr);
        case VM:
            return new OsVMNotificationListener(vc, objectType, objectIdList, entity, this.dsConformService,
                    this.sgConformService, this.alertGenerator, this.activeRunner, this.dbMgr);
        case HOST_AGGREGRATE:
            return new OsHostAggregrateNotificationListener(vc, objectType, objectIdList, entity, this.dsConformService,
                    this.alertGenerator, this.activeRunner, this.dbMgr.getTransactionControl());
        case PROJECT:
            return new OsProjectNotificationListener(vc, objectType, objectIdList, entity, this.dsConformService,
                    this.sgConformService, this.alertGenerator, this.activeRunner, this.dbMgr);
        case NETWORK:
            return new OsNetworkNotificationListener(vc, objectType, objectIdList, entity, this.dsConformService,
                    this.sgConformService, this.alertGenerator, this.activeRunner, this.dbMgr.getTransactionControl());
        default:
            break;
        }
