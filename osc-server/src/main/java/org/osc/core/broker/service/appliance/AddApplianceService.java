...
implements AddApplianceServiceApi {
    ...
    @Override
    public BaseResponse exec(ImageMetadataRequest request, EntityManager em) throws Exception {
        BaseResponse response = new BaseResponse();
        Long id = addAppliance(request, em);
        response.setId(id);
        return response;
    }

    public Long addAppliance(ImageMetadataRequest imageMetadata) throws Exception {
        return addAppliance(imageMetadata, getEntityManager());
    }

    public Long addAppliance(ImageMetadataRequest imageMetadata,  EntityManager em)
            throws Exception {
