...
public class OpenstackUtil {
    ...
    private static final Logger LOG = LogProvider.getLogger(OpenstackUtil.class);
    ...
    private static final class StartSecurityGroupJobListener implements JobCompletionListener {
        private final Logger log = LogProvider.getLogger(StartSecurityGroupJobListener.class);
