    ...
    public void executeTransaction(EntityManager em) throws Exception {
        ...
        if (floatingIp != null) {
            if (floatingIp.getInstanceId() == null) {
                ...
                this.log.info("Original Floating ip: " + floatingIp.getFloatingIpAddress()
                ...
                throw new IllegalStateException(
                        "No Floating Ip assigned to instance. Please assign the original Floating ip: "
                                + floatingIp.getFloatingIpAddress() + " to this instance to fix the issue.");
            }
        } else {
            // Floating ip is invalid or has never been assigned to this sva for some reason, try adding it now.
            FloatingIP allocatedFloatingIp = nova.allocateFloatingIp(ds.getRegion(),
