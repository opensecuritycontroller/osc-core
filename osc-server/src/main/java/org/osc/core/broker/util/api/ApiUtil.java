...
public interface ApiUtil {
    ...
    <T extends BaseDto> OscBadRequestException createIdMismatchException(Long id, String objName);

    <T extends BaseDto> OscBadRequestException createParentChildMismatchException(Long parentId, String objName);
}
