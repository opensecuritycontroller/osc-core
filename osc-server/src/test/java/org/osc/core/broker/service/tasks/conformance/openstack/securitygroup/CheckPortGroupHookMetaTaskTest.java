...
public class CheckPortGroupHookMetaTaskTest {
    ...
    @Test
    public void testExecuteTransaction_WithVariousDeploymentSpecs_ExpectsValidTaskGraphOrException() throws Exception {
        // Arrange.
        CheckPortGroupHookMetaTask task = new CheckPortGroupHookMetaTask(this.sgi, this.isDeleteTg);
