...
public class ImportApplianceSoftwareVersionServiceTest {
    ...
    private static final Long MC_ID_VALID_MC = 111L;
    ...
    private static final String NON_EXISTING_OVF_IMAGE_NAME = "bar.ovf";
    ...
    public void testDispatch_ImportApplianceNonExistingModel_ExpectsValidResponse() throws Exception {
        ...
        verifySuccessfulImport(response);
    }
    ...
    private void verifySuccessfulImport(BaseResponse response) throws IOException, Exception {
        ...
        // asv ID matches
        assertEquals("Appliance Software Version Id mismatch", ASV_ID, response.getId());
