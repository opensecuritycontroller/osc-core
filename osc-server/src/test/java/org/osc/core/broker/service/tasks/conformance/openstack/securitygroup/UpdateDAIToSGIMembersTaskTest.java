...
public class UpdateDAIToSGIMembersTaskTest {
    ...
    protected void testExecute_WhenSGIHasNoAssociatedSG_NoUpdateIsDone(UpdateDAIToSGIMembersTask factory)
            throws Exception {
        // Arrange.
        SecurityGroupInterface sgi = registerNewSGI(null);
        DistributedApplianceInstance dai = registerNewDAI();

        UpdateDAIToSGIMembersTask task = factory.create(sgi, dai);
    ...
    protected void testExecute_WhenSGIHasNoAssociatedSGMember_NoUpdateIsDone(UpdateDAIToSGIMembersTask factory)
            throws Exception {
        // Arrange.
