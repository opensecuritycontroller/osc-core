...
public class KeyStoreProviderTest {
    ...
    public void setUp() throws Exception {
        this.testKeyStore = KeyStore.getInstance("PKCS12");
        this.testKeyStore.load(null, null);
        this.testKeyStoreFactory = mock(KeyStoreProvider.KeyStoreFactory.class);
        when(this.testKeyStoreFactory.createKeyStore()).thenReturn(this.testKeyStore);
    ...
    public void testPutPassword_withNullAlias_throwsKeyStoreProviderException() throws Exception {
        ...
        // Assert.
        this.exception.expect(KeyStoreProviderException.class);
